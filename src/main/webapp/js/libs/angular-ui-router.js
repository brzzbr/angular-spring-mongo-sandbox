    ...
    function o(a, b) {
        ...
        this.study = function (i) {
            ...
            return L(i, n), i = r = s = null, function (d, f, g) {
                ...
                f.$$inheritedValues && e(t, l(f.$$inheritedValues, p)), M(s, f.$$promises), f.$$values ? (v = e(t, l(f.$$values, p)), r
                .
                $$inheritedValues = l(f.$$values, p), h()
                ):
                (f.$$inheritedValues && (r.$$inheritedValues = l(f.$$inheritedValues, p)), f.then(h, i));
            ...
            restrict: "A", require: ["?^uiSrefActive", "?^uiSrefActiveEq"], link: function (e, f, g, h) {
                ...
                var s = function (c) {
                    if (c && (j = b.copy(c)), p) {
                        ...
                        var d = h[1] || h[0];
                        return d && d.$$setStateInfo(i.state, j), null === l ? (p = !1,!1
                    ):
                        void g.$set(o, l)
                    }
                };
